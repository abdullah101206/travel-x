...
const packages = [
  ...
  },
  {
    ...
    desc:
      "Maldives is known for crystal-clear water, private resorts, and romantic overwater villas. It is a top honeymoon destination. Peaceful beaches make it a luxury escape.",
    price: "$2000",
  },
  {
    ...
    desc:
      "Turkey connects Asia and Europe with rich history and culture. Istanbul offers mosques, bazaars, and historic sites. It is famous for food, heritage, and scenic views.",
  },
  {
    ...
    desc:
      "Switzerland is famous for snowy mountains, lakes, and scenic train journeys. It is a peaceful and luxury travel destination. Perfect for nature lovers and adventure seekers.",
  },
  {
    ...
    desc:
      "Paris is known as the city of love with Eiffel Tower and art museums. It offers romantic streets and cafes. It is a dream destination for couples and tourists.",
  },
  {
    ...
    desc:
      "Thailand is famous for islands, beaches, and street food culture. It is budget-friendly and full of adventure. Night markets and temples attract millions of tourists.",
  },
  {
    ...
    desc:
      "Japan blends advanced technology with deep tradition. Tokyo and Kyoto are top tourist cities. Cherry blossoms and culture make it highly popular worldwide.",
  },
  {
    ...
    desc:
      "London is a historic and modern city with famous landmarks like Big Ben. It is a global business and tourism hub. Rich culture and museums attract visitors.",
  },
  {
    ...
    desc:
      "New York is known for skyscrapers, Times Square, and Statue of Liberty. It is a fast-moving global city. Shopping, nightlife, and culture make it iconic.",
  },
  {
    ...
    desc:
      "Italy is rich in history, art, and architecture. Rome, Venice, and Florence are top attractions. It is famous for food, culture, and ancient heritage.",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1500375592092-40eb2168fd21?auto=format&fit=crop&w=1200&q=80",
    desc:
      "Bali is a tropical paradise with beaches, temples, and rice terraces. It is popular for honeymoon and relaxation. Affordable luxury makes it very attractive.",
  },
  {
    ...
    desc:
      "Georgia is a budget-friendly destination with mountains and old cities. It is visa-friendly for many travelers. Food, culture, and nature attract tourists.",
  },
];
