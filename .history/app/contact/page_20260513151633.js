      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            {/* Location */}
            <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100 hover:shadow-md transition">
            ...
            {/* Email */}
            <div className="p-6 bg-purple-50 rounded-2xl border border-purple-100 hover:shadow-md transition">
            ...
            {/* Phone */}
            <div className="p-6 bg-emerald-50 rounded-2xl border border-emerald-100 hover:shadow-md transition">
