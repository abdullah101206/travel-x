      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-500 max-w-2xl mx-auto text-lg">
            Have questions or need help? We’re always here to help you plan your perfect journey.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-white/80 backdrop-blur-md rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition-all">
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-10">
            ...
            {/* Success */}
            {success && (
              <div className="mb-6 rounded-xl bg-green-50 border border-green-200 px-4 py-3 text-green-700 font-medium shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#1E3A8A] to-[#38BDF8] hover:from-[#16306f] hover:to-[#0ea5e9] text-white font-semibold py-3 rounded-xl shadow-md hover:shadow-lg transition-all"
              >
                Send Message
              </button>
