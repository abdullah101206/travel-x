        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r curs from-[#1E3A8A] to-[#38BDF8] hover:from-[#16306f] hover:to-[#0ea5e9] text-white font-semibold py-3 rounded-xl shadow-md hover:shadow-lg transition-all"
              >
                Send Message
              </button>
