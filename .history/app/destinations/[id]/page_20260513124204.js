      ...
      <div className="relative">
        ...
        <div className="absolute bottom-10 left-10 text-white">
          ...
          <p className="mt-4 max-w-xl text-gray-200">
            Explore luxury travel packages with hotels, transport, meals, and guided tours included.
          </p>
        </div>
      </div>
          ...
          {packages.map((pkg) => (
            ...
            >
              ...
              <div className="mt-8 flex justify-between items-center">
                ...
                <button className="bg-gradient-to-r from-[#1E3A8A] to-[#38BDF8] text-white px-6 py-3 rounded-full hover:scale-105 transition">
                  Book Now
                </button>
              </div>
            </div>
