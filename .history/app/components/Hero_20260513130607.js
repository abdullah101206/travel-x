      ...
      <div className="max-w-7xl mx-auto min-h-[90vh] px-6 py-20 flex flex-col-reverse lg:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
            ...
            <Link
              href="/destinations"
              className="w-full sm:w-auto rounded-full bg-gradient-to-r from-[#1E3A8A] to-[#38BDF8] px-8 py-4 text-center text-base font-semibold text-white shadow-xl transition-all duration-300 hover:scale-105 hover:brightness-110"
            >
