...
export default async function PackageDetails({ params }) {
  ...
  {/* CONTENT + SIDE CARD */}
  <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-8 mt-10 px-5">
    ...
    <div className="lg:col-span-2 space-y-6">
      ...
      {singlePackage.packages.map((pkg, i) => (
        <div
          key={i}
          className="bg-white/80 backdrop-blur-lg border shadow-xl rounded-3xl p-6 hover:scale-[1.02] transition"
        >
    ...
    <div className="lg:col-span-1">
      <div className="sticky top-10 bg-white shadow-2xl rounded-3xl p-6 border">
        ...
        <p className="text-gray-600 text-sm mb-4">
          Select your package and book instantly.
        </p>
        ...
        <button className="w-full mt-3 border py-3 rounded-xl hover:bg-gray-100">
          Enquire Now
        </button>
